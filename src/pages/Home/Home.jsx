...
const Home = () => {
    return (
        <div className=''>
            <div className=' bg-[#1746A2] py-6 px-4' style={{width:''}}>
                <div className='md:flex justify-between items-center'>
                    <div className=' text-[#] w-2/6'>
                        ...
                        <p className='  text-[#F5F7F8] text-xl p'>Find awesome hotel, car and activities in london </p>
                    </div>
                ...
                <div className='flex-col'>
                    <label htmlFor="Destination" className='text-white rounded flex-col'>Destination</label>
                    <input type="text" name="" placeholder='Where to go' className='tex-[#]' id="" />
                </div>
            </div>
            <div></div>
        </div>
